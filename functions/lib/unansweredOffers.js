...
exports.enactUnansweredOffers = void 0;
const functions = require("firebase-functions/v1");
const admin = require("firebase-admin");
const db = admin.firestore();
exports.enactUnansweredOffers = functions.pubsub.schedule("every 1 hours").onRun(async (context) => {
    const now = Date.now();
    ...
    for (const offerDoc of snapshot.docs) {
        ...
        try {
            await db.runTransaction(async (transaction) => {
                ...
                if ((freshOffer === null || freshOffer === void 0 ? void 0 : freshOffer.status) !== 'pending')
                ...
                if ((tile === null || tile === void 0 ? void 0 : tile.ownerId) !== freshOffer.sellerId) {
...
//# sourceMappingURL=unansweredOffers.js.map