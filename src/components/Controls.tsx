...
export function Controls({
    ...
    return (
        <div className="absolute bottom-32 left-0 right-0 px-4 z-[1000] flex flex-col items-center gap-4">
                    ...
                    {!ceremonyHere ? (
                        <div className="relative">
                            <div className="flex items-center gap-3 bg-slate-800/80 p-2 pr-2 rounded-full border border-white/10 shadow-lg backdrop-blur-sm">
                                <div className="pl-4 font-black text-white uppercase tracking-wider text-xs">
                                    Claimed!
                                </div>
                                <button
                                    onClick={() => setShowMenu(!showMenu)}
                                    className="w-8 h-8 flex items-center justify-center rounded-full bg-slate-700 hover:bg-slate-600 text-white transition-colors active:scale-95"
                                >
            ...
            <div className="bg-slate-900/80 backdrop-blur-md text-white p-2 px-3 rounded-lg shadow-lg flex items-center gap-3 border border-slate-700 scale-90">
